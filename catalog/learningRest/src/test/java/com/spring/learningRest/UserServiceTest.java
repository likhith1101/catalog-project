...
public class UserServiceTest {
    ...
    @Test
    public void testAuthenticate_WhenUserExistsAndCorrectPassword_ExpectUserReturned() {
        // Arrange
    ...
    @Test
    public void testAuthenticate_WhenUserDoesNotExist_ExpectNotFoundException() {
        // Arrange
    ...
    @Test
    public void testAuthenticate_WhenUserExistsButWrongPassword_ExpectEmptyOptional() {
        // Arrange
        String username = "testUser";
    ...
    @Test
    public void testCreateUser_WithValidUser_ExpectUserCreated() {
        // Arrange
        User user = new User();
    ...
    @Test
    public void testCreateUser_WithDuplicateUsername_ExpectUserNotCreated() {
        // Arrange
    ...
    @Test
    public void testGetUserById_WithValidId_ExpectUserReturned() {
        // Arrange
        int userId = 1;
        User user = new User();
        user.setId(userId);
    ...
    @Test
    public void testGetUserById_WithInvalidId_ExpectEmptyOptional() {
        // Arrange
        int userId = 1;
    ...
    @Test
    public void testExistsByName_WithExistingUsername_ExpectTrue() {
        // Arrange
    ...
    @Test
    public void testExistsByName_WithNonExistentUsername_ExpectFalse() {
        // Arrange
        String username = "nonExistentUser";
